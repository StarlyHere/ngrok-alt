...
public class KafkaForwardingConsumer {
    ...
    @KafkaListener(topicPattern = "notifications_.*", groupId = "tunnel-router")
    ...
    private String buildBody(ConsumerRecord<String, byte[]> record, String sessionId) {
        // Topic is notifications_<sessionId>; strip the prefix underscore to get "notifications".
        String baseTopic = TOPIC_PREFIX.substring(0, TOPIC_PREFIX.length() - 1);
